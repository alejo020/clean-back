...
export interface ApiImplementoImplemento extends Struct.CollectionTypeSchema {
  collectionName: 'implementos';
  info: {
    displayName: 'Implemento';
    pluralName: 'implementos';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Implemento: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::implemento.implemento'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiListaServicioListaServicio
  extends Struct.CollectionTypeSchema {
  collectionName: 'lista_servicios';
  info: {
    description: '';
    displayName: 'lista-servicio';
    pluralName: 'lista-servicios';
    singularName: 'lista-servicio';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiServicioImplementadoServicioImplementado
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    implemento: Schema.Attribute.Relation<
      'oneToOne',
      'api::implemento.implemento'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::servicio-implementado.servicio-implementado'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::implemento.implemento': ApiImplementoImplemento;
      'api::lista-servicio.lista-servicio': ApiListaServicioListaServicio;
      'api::servicio-implementado.servicio-implementado': ApiServicioImplementadoServicioImplementado;
